...
Uo(ll).center;
const hl = Math.sqrt(50), dl = Math.sqrt(10), pl = Math.sqrt(2);
function me(t, n, e) {
  const r = (n - t) / Math.max(0, e), i = Math.floor(Math.log10(r)), a = r / Math.pow(10, i), o = a >= hl ? 10 : a >= dl ? 5 : a >= pl ? 2 : 1;
  let s, l, u;
...
var pr = 1, gr = 2, Pr = 3, vn = 4, ia = 1e-6;
function ml(t) {
...
function Yo(t, n) {
  var e = [], r = null, i = null, a = 6, o = 6, s = 3, l = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : 0.5, u = t === pr || t === vn ? -1 : 1, c = t === vn || t === gr ? "x" : "y", h = t === pr || t === Pr ? ml : vl;
  function f(d) {
    var g = r ?? (n.ticks ? n.ticks.apply(n, e) : n.domain()), y = i ?? (n.tickFormat ? n.tickFormat.apply(n, e) : yl), w = Math.max(a, 0) + s, x = n.range(), p = +x[0] + l, M = +x[x.length - 1] + l, _ = (n.bandwidth ? bl : wl)(n.copy(), l), v = d.selection ? d.selection() : d, N = v.selectAll(".domain").data([null]), T = v.selectAll(".tick").data(g, n).order(), z = T.exit(), L = T.enter().append("g").attr("class", "tick"), R = T.select("line"), m = T.select("text");
    N = N.merge(N.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), T = T.merge(L), R = R.merge(L.append("line").attr("stroke", "currentColor").attr(c + "2", u * a)), m = m.merge(L.append("text").attr("fill", "currentColor").attr(c, u * w).attr("dy", t === pr ? "0em" : t === Pr ? "0.71em" : "0.32em")), d !== v && (N = N.transition(d), T = T.transition(d), R = R.transition(d), m = m.transition(d), z = z.transition(d).attr("opacity", ia).attr("transform", function(S) {
      return isFinite(S = _(S)) ? h(S + l) : this.getAttribute("transform");
    }), L.attr("opacity", ia).attr("transform", function(S) {
      var $ = this.parentNode.__axis;
      return h(($ && isFinite($ = $(S)) ? $ : _(S)) + l);
    })), z.remove(), N.attr("d", t === vn || t === gr ? o ? "M" + u * o + "," + p + "H" + l + "V" + M + "H" + u * o : "M" + l + "," + p + "V" + M : o ? "M" + p + "," + u * o + "V" + l + "H" + M + "V" + u * o : "M" + p + "," + l + "H" + M), T.attr("opacity", 1).attr("transform", function(S) {
      return h(_(S) + l);
    }), R.attr(c + "2", u * a), m.attr(c, u * w).text(y), v.filter(xl).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === gr ? "start" : t === vn ? "end" : "middle"), v.each(function() {
      this.__axis = _;
    });
  }
...
se.prototype = Go.prototype = {
  constructor: se,
  on: function(t, n) {
    var e = this._, r = Tl(t + "", e), i, a = -1, o = r.length;
    ...
    for (; ++a < o; )
      if (i = (t = r[a]).type) e[i] = aa(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = aa(e[i], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, n = this._;
...
function qe(t) {
  var n = t += "", e = n.indexOf(":");
  return e >= 0 && (n = t.slice(0, e)) !== "xmlns" && (t = t.slice(e + 1)), oa.hasOwnProperty(n) ? { space: oa[n], local: t } : t;
}
function Nl(t) {
  return function() {
...
function Ll(t) {
  return this.select(t == null ? Fl : jl(typeof t == "function" ? t : Wo(t)));
}
...
function Xl(t) {
  return this.selectAll(t == null ? ql : Hl(typeof t == "function" ? t : Wo(t)));
}
function Bl(t) {
...
function Ul() {
  return new B(this._enter || this._groups.map(Jo), this._parents);
}
function ve(t, n) {
...
function Vl(t, n, e, r, i, a, o) {
  var s, l, u = /* @__PURE__ */ new Map(), c = n.length, h = a.length, f = new Array(c), d;
  for (s = 0; s < c; ++s)
    (l = n[s]) && (f[s] = d = o.call(l, l.__data__, s, n) + "", u.has(d) ? i[s] = l : u.set(d, l));
  for (s = 0; s < h; ++s)
    d = o.call(t, a[s], s, a) + "", (l = u.get(d)) ? (r[s] = l, l.__data__ = a[s], u.delete(d)) : e[s] = new ve(t, a[s]);
  for (s = 0; s < c; ++s)
...
function Zl(t, n) {
  ...
  for (var a = i.length, o = new Array(a), s = new Array(a), l = new Array(a), u = 0; u < a; ++u) {
    var c = r[u], h = i[u], f = h.length, d = Wl(t.call(c, c && c.__data__, u, r)), g = d.length, y = s[u] = new Array(g), w = o[u] = new Array(g), x = l[u] = new Array(f);
    e(c, h, y, w, x, d, n);
    for (var p = 0, M = 0, _, v; p < g; ++p)
      if (_ = y[p]) {
        for (p >= M && (M = p + 1); !(v = w[M]) && ++M < g; ) ;
        _._next = v || null;
      }
  }
...
function Jl() {
  return new B(this._exit || this._groups.map(Jo), this._parents);
}
function Ql(t, n, e) {
...
function tc(t) {
  for (var n = t.selection ? t.selection() : t, e = this._groups, r = n._groups, i = e.length, a = r.length, o = Math.min(i, a), s = new Array(i), l = 0; l < o; ++l)
    for (var u = e[l], c = r[l], h = u.length, f = s[l] = new Array(h), d, g = 0; g < h; ++g)
      (d = u[g] || c[g]) && (f[g] = d);
  for (; l < i; ++l)
    s[l] = e[l];
...
function _c(t, n) {
  ...
  return this.each((n == null ? e.local ? fc : cc : typeof n == "function" ? e.local ? gc : pc : e.local ? dc : hc)(e, n));
}
function Qo(t) {
...
function Nc(t, n) {
  ...
  return this.each((typeof n == "function" ? kc : n ? $c : Tc)(e, n));
}
function Sc() {
  this.textContent = "";
}
...
function Oc(t) {
  return arguments.length ? this.each(t == null ? Sc : (typeof t == "function" ? Ec : Pc)(t)) : this.node().textContent;
}
function zc() {
  this.innerHTML = "";
}
...
function Rc(t) {
  return arguments.length ? this.each(t == null ? zc : (typeof t == "function" ? Ic : Cc)(t)) : this.node().innerHTML;
}
function jc() {
...
function qn() {
  return new B([[document.documentElement]], as);
}
function of() {
  return this;
}
...
function sf(t) {
  return typeof t == "string" ? new B([[document.querySelector(t)]], [document.documentElement]) : new B([[t]], as);
}
function gi(t, n, e) {
...
var Nn = 0.7, we = 1 / Nn, Kt = "\\s*([+-]?\\d+)\\s*", Sn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", uf = /^#([0-9a-f]{3,8})$/, lf = new RegExp(`^rgb\\(${Kt},${Kt},${Kt}\\)$`), cf = new RegExp(`^rgb\\(${rt},${rt},${rt}\\)$`), ff = new RegExp(`^rgba\\(${Kt},${Kt},${Kt},${Sn}\\)$`), hf = new RegExp(`^rgba\\(${rt},${rt},${rt},${Sn}\\)$`), df = new RegExp(`^hsl\\(${Sn},${rt},${rt}\\)$`), pf = new RegExp(`^hsla\\(${Sn},${rt},${rt},${Sn}\\)$`), sa = {
  aliceblue: 15792383,
...
function It(t) {
  var n, e;
  return t = (t + "").trim().toLowerCase(), (n = uf.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), e === 6 ? ca(n) : e === 3 ? new q(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, (n & 15) << 4 | n & 15, 1) : e === 8 ? Gn(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (n & 255) / 255) : e === 4 ? Gn(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, ((n & 15) << 4 | n & 15) / 255) : null) : (n = lf.exec(t)) ? new q(n[1], n[2], n[3], 1) : (n = cf.exec(t)) ? new q(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, 1) : (n = ff.exec(t)) ? Gn(n[1], n[2], n[3], n[4]) : (n = hf.exec(t)) ? Gn(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, n[4]) : (n = df.exec(t)) ? da(n[1], n[2] / 100, n[3] / 100, 1) : (n = pf.exec(t)) ? da(n[1], n[2] / 100, n[3] / 100, n[4]) : sa.hasOwnProperty(t) ? ca(sa[t]) : t === "transparent" ? new q(NaN, NaN, NaN, 0) : null;
}
function ca(t) {
...
function yf(t) {
  return t instanceof Hn || (t = It(t)), t ? (t = t.rgb(), new q(t.r, t.g, t.b, t.opacity)) : new q();
}
function be(t, n, e, r) {
  return arguments.length === 1 ? yf(t) : new q(t, n, e, r ?? 1);
}
function q(t, n, e, r) {
...
gi(q, be, os(Hn, {
  brighter(t) {
    return t = t == null ? we : Math.pow(we, t), new q(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  darker(t) {
    return t = t == null ? Nn : Math.pow(Nn, t), new q(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new q(zt(this.r), zt(this.g), zt(this.b), xe(this.opacity));
  },
  displayable() {
...
gi(W, vf, os(Hn, {
  ...
  darker(t) {
    return t = t == null ? Nn : Math.pow(Nn, t), new W(this.h, this.s, this.l * t, this.opacity);
  },
  rgb() {
  ...
  clamp() {
    return new W(pa(this.h), Vn(this.s), Vn(this.l), xe(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const t = xe(this.opacity);
    return `${t === 1 ? "hsl(" : "hsla("}${pa(this.h)}, ${Vn(this.s) * 100}%, ${Vn(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
  }
}));
function pa(t) {
...
function Af(t) {
  return (t = +t) == 1 ? us : function(n, e) {
    return e - n ? Mf(n, e, t) : _i(isNaN(n) ? e : n);
  };
}
function us(t, n) {
  var e = n - t;
...
function ls(t, n) {
  ...
  return e < n.length && (a = n.slice(e), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? l[0] ? zf(l[0].x) : Of(n) : (n = l.length, function(u) {
...
function yi(t, n) {
  var e = typeof n, r;
  return n == null || e === "boolean" ? _i(n) : (e === "number" ? K : e === "string" ? (r = It(n)) ? (n = r, Me) : ls : n instanceof It ? Me : n instanceof Date ? Pf : Nf(n) ? kf : Array.isArray(n) ? Sf : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? Ef : K)(t, n);
}
function Cf(t, n) {
  return t = +t, n = +n, function(e) {
...
function If(t) {
  ...
  return n.isIdentity ? zr : cs(n.a, n.b, n.c, n.d, n.e, n.f);
}
function Rf(t) {
  return t == null || (Kn || (Kn = document.createElementNS("http://www.w3.org/2000/svg", "g")), Kn.setAttribute("transform", t), !(t = Kn.transform.baseVal.consolidate())) ? zr : (t = t.matrix, cs(t.a, t.b, t.c, t.d, t.e, t.f));
}
function fs(t, n, e, r) {
  function i(u) {
    return u.length ? u.pop() + " " : "";
  }
  function a(u, c, h, f, d, g) {
    if (u !== h || c !== f) {
      var y = d.push("translate(", null, n, null, e);
      g.push({ i: y - 4, x: K(u, h) }, { i: y - 2, x: K(c, f) });
  ...
  return function(u, c) {
    ...
    return u = t(u), c = t(c), a(u.translateX, u.translateY, c.translateX, c.translateY, h, f), o(u.rotate, c.rotate, h, f), s(u.skewX, c.skewX, h, f), l(u.scaleX, u.scaleY, c.scaleX, c.scaleY, h, f), u = c = null, function(d) {
      for (var g = -1, y = f.length, w; ++g < y; ) h[(w = f[g]).i] = w.x(d);
      return h.join("");
    };
  };
}
var jf = fs(If, "px, ", "px)", "deg)"), Ff = fs(Rf, ", ", ")", ")"), en = 0, wn = 0, gn = 0, hs = 1e3, Ae, bn, $e = 0, Rt = 0, He = 0, Pn = typeof performance == "object" && performance.now ? performance : Date, ds = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function Xe() {
  return Rt || (ds(Lf), Rt = Pn.now() + He);
}
function Lf() {
  Rt = 0;
}
...
En.prototype = ps.prototype = {
  constructor: En,
  restart: function(t, n, e) {
    if (typeof t != "function") throw new TypeError("callback is not a function");
    e = (e == null ? Xe() : +e) + (n == null ? 0 : +n), !this._next && bn !== this && (bn ? bn._next = this : Ae = this, bn = this), this._call = t, this._time = e, Cr();
  },
  stop: function() {
...
function Cr(t) {
  if (!en) {
    ...
    var n = t - Rt;
    n > 24 ? (t < 1 / 0 && (wn = setTimeout(_a, t - Pn.now() - He)), gn && (gn = clearInterval(gn))) : (gn || ($e = Pn.now(), gn = setInterval(qf, hs)), en = 1, ds(_a));
  }
}
function ya(t, n, e) {
  var r = new En();
...
var Bf = Go("start", "end", "cancel", "interrupt"), Uf = [], gs = 0, ma = 1, Ir = 2, ue = 3, va = 4, Rr = 5, le = 6;
  ...
  function o(u) {
    ...
    for (c in r)
      if (d = r[c], d.name === e.name) {
        if (d.state === ue) return ya(o);
        d.state === va ? (d.state = le, d.timer.stop(), d.on.call("interrupt", t, t.__data__, d.index, d.group), delete r[c]) : +c < n && (d.state = le, d.timer.stop(), d.on.call("cancel", t, t.__data__, d.index, d.group), delete r[c]);
      }
    if (ya(function() {
      e.state === ue && (e.state = va, e.timer.restart(s, e.delay, e.time), s(u));
...
function ih(t, n) {
  var e = qe(t), r = e === "transform" ? Ff : _s;
  return this.attrTween(t, typeof n == "function" ? (e.local ? rh : eh)(e, r, vi(this, "attr." + t, n)) : n == null ? (e.local ? Qf : Jf)(e) : (e.local ? nh : th)(e, r, n));
}
function ah(t, n) {
  return function(e) {
...
function gh(t) {
  var n = this._id;
  return arguments.length ? this.each((typeof t == "function" ? dh : ph)(n, t)) : tt(this.node(), n).duration;
}
function _h(t, n) {
  if (typeof n != "function") throw new Error();
  return function() {
...
function bh(t) {
  ...
  for (var n = this._groups, e = t._groups, r = n.length, i = e.length, a = Math.min(r, i), o = new Array(r), s = 0; s < a; ++s)
    for (var l = n[s], u = e[s], c = l.length, h = o[s] = new Array(c), f, d = 0; d < c; ++d)
      (f = l[d] || u[d]) && (h[d] = f);
  for (; s < r; ++s)
    o[s] = n[s];
...
function Nh(t) {
  ...
  for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s)
    for (var l = r[s], u = l.length, c, h = 0; h < u; ++h)
      if (c = l[h]) {
        for (var f = t.call(c, c.__data__, h, l), d, g = tt(c, e), y = 0, w = f.length; y < w; ++y)
          (d = f[y]) && Be(d, n, e, y, f, g);
        a.push(f), o.push(c);
      }
  return new dt(a, o, n, e);
}
var Sh = qn.prototype.constructor;
function Ph() {
...
function Ih(t, n, e) {
  ...
  return n == null ? this.styleTween(t, Eh(t, r)).on("end.style." + t, ys(t)) : typeof n == "function" ? this.styleTween(t, zh(t, r, vi(this, "style." + t, n))).each(Ch(this._id, t)) : this.styleTween(t, Oh(t, r, n), e).on("end.style." + t, null);
}
function Rh(t, n, e) {
  return function(r) {
...
function qh(t) {
  return this.tween("text", typeof t == "function" ? Dh(vi(this, "text", t)) : Lh(t == null ? "" : t + ""));
}
function Hh(t) {
  return function(n) {
...
function Wh(t) {
  var n, e;
  t instanceof dt ? (n = t._id, t = t._name) : (n = ms(), (e = Kh).time = Xe(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
    for (var o = r[a], s = o.length, l, u = 0; u < s; ++u)
      (l = o[u]) && Be(l, t, n, u, o, e || Zh(l, n));
  return new dt(r, this._parents, t, n);
}
qn.prototype.interrupt = Vf;
qn.prototype.transition = Wh;
const jr = Math.PI, Fr = 2 * jr, St = 1e-6, Jh = Fr - St;
function vs(t) {
  this._ += t[0];
...
class td {
  ...
  arcTo(n, e, r, i, a) {
    ...
    if (this._x1 === null)
      ...
      let d = r - o, g = i - s, y = l * l + u * u, w = d * d + g * g, x = Math.sqrt(y), p = Math.sqrt(f), M = a * Math.tan((jr - Math.acos((y + f - w) / (2 * x * p))) / 2), _ = M / p, v = M / x;
      Math.abs(_ - 1) > St && this._append`L${n + _ * c},${e + _ * h}`, this._append`A${a},${a},0,0,${+(h * d > c * g)},${this._x1 = n + v * l},${this._y1 = e + v * u}`;
    }
  }
  arc(n, e, r, i, a, o) {
    if (n = +n, e = +e, r = +r, o = !!o, r < 0) throw new Error(`negative radius: ${r}`);
    let s = r * Math.cos(i), l = r * Math.sin(i), u = n + s, c = e + l, h = 1 ^ o, f = o ? i - a : a - i;
    this._x1 === null ? this._append`M${u},${c}` : (Math.abs(this._x1 - u) > St || Math.abs(this._y1 - c) > St) && this._append`L${u},${c}`, r && (f < 0 && (f = f % Fr + Fr), f > Jh ? this._append`A${r},${r},0,1,${h},${n - s},${e - l}A${r},${r},0,1,${h},${this._x1 = u},${this._y1 = c}` : f > St && this._append`A${r},${r},0,${+(f >= jr)},${h},${this._x1 = n + r * Math.cos(a)},${this._y1 = e + r * Math.sin(a)}`);
  }
  rect(n, e, r, i) {
...
var id = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function ke(t) {
  if (!(n = id.exec(t))) throw new Error("invalid format: " + t);
  var n;
  return new wi({
    fill: n[1],
    align: n[2],
...
function od(t, n) {
  ...
  return a === o ? r : a > o ? r + new Array(a - o + 1).join("0") : a > 0 ? r.slice(0, a) + "." + r.slice(a) : "0." + new Array(1 - a).join("0") + Te(t, Math.max(0, n + a - 1))[0];
}
function wa(t, n) {
  var e = Te(t, n);
  if (!e) return t + "";
...
var Ma = Array.prototype.map, Aa = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function sd(t) {
  var n = t.grouping === void 0 || t.thousands === void 0 ? xa : ed(Ma.call(t.grouping, Number), t.thousands + ""), e = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", i = t.decimal === void 0 ? "." : t.decimal + "", a = t.numerals === void 0 ? xa : rd(Ma.call(t.numerals, String)), o = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", l = t.nan === void 0 ? "NaN" : t.nan + "";
  function u(h) {
    h = ke(h);
    var f = h.fill, d = h.align, g = h.sign, y = h.symbol, w = h.zero, x = h.width, p = h.comma, M = h.precision, _ = h.trim, v = h.type;
    v === "n" ? (p = !0, v = "g") : ba[v] || (M === void 0 && (M = 12), _ = !0, v = "g"), (w || f === "0" && d === "=") && (w = !0, f = "0", d = "=");
    var N = y === "$" ? e : y === "#" && /[boxX]/.test(v) ? "0" + v.toLowerCase() : "", T = y === "$" ? r : /[%p]/.test(v) ? o : "", z = ba[v], L = /[defgprs%]/.test(v);
    ...
    function R(m) {
      ...
      if (v === "c")
        ...
        m = +m;
        var Y = m < 0 || 1 / m < 0;
        if (m = isNaN(m) ? l : z(Math.abs(m), M), _ && (m = ad(m)), Y && +m == 0 && g !== "+" && (Y = !1), S = (Y ? g === "(" ? g : s : g === "-" || g === "(" ? "" : g) + S, $ = (v === "s" ? Aa[8 + ws / 3] : "") + $ + (Y && g === "(" ? ")" : ""), L) {
          for (j = -1, Nt = m.length; ++j < Nt; )
            if (X = m.charCodeAt(j), 48 > X || X > 57) {
              $ = (X === 46 ? i + m.slice(j + 1) : m.slice(j)) + $, m = m.slice(0, j);
              break;
            }
        }
      }
      p && !w && (m = n(m, 1 / 0));
      var V = S.length + m.length + $.length, C = V < x ? new Array(x - V + 1).join(f) : "";
      switch (p && w && (m = n(C + m, C.length ? x - $.length : 1 / 0), C = ""), d) {
        case "<":
          m = S + m + $ + C;
          break;
        case "=":
  ...
  function c(h, f) {
    var d = u((h = ke(h), h.type = "f", h)), g = Math.max(-8, Math.min(8, Math.floor(rn(f) / 3))) * 3, y = Math.pow(10, -g), w = Aa[8 + g / 3];
    return function(x) {
      return d(y * x) + w;
    };
  }
...
function ud(t) {
  return Zn = sd(t), bs = Zn.format, xs = Zn.formatPrefix, Zn;
}
function ld(t) {
...
const hd = Math.random, dd = function t(n) {
  function e(r, i) {
    var a, o;
...
function md(t, n, e) {
  ...
  return i < r ? (r = Lr(i, r), a = e(o, a)) : (r = Lr(r, i), a = e(a, o)), function(s) {
    return a(r(s));
  };
}
function vd(t, n, e) {
  ...
  for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++o < r; )
    i[o] = Lr(t[o], t[o + 1]), a[o] = e(n[o], n[o + 1]);
  return function(s) {
    var l = fl(t, s, 1, r) - 1;
    return a[l](i[l](s));
  };
...
function bd() {
  var t = $a, n = $a, e = yi, r, i, a, o = Gt, s, l, u;
  function c() {
    var f = Math.min(t.length, n.length);
    return o !== Gt && (o = yd(t[0], t[f - 1])), s = f > 2 ? vd : md, l = u = null, h;
  }
  function h(f) {
  ...
  return h.invert = function(f) {
    ...
    return arguments.length ? (t = Array.from(f, _d), c()) : t.slice();
  }, h.range = function(f) {
...
function Md(t, n, e, r) {
  ...
  switch (r = ke(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(a = cd(i, o)) && (r.precision = a), xs(r, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      r.precision == null && !isNaN(a = fd(i, Math.max(Math.abs(t), Math.abs(n)))) && (r.precision = a - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
      r.precision == null && !isNaN(a = ld(i)) && (r.precision = a - (r.type === "%") * 2);
      break;
    }
  }
  return bs(r);
...
function Ad(t) {
  ...
  return t.ticks = function(e) {
    ...
    var i = n();
    return Md(i[0], i[i.length - 1], e ?? 10, r);
  }, t.nice = function(e) {
    e == null && (e = 10);
...
function Ts(t, n) {
  var e = Yt(!0), r = null, i = Ed, a = null, o = Sd(s);
  t = typeof t == "function" ? t : t === void 0 ? Od : Yt(t), n = typeof n == "function" ? n : n === void 0 ? zd : Yt(n);
  function s(l) {
    var u, c = (l = Pd(l)).length, h, f = !1, d;
    for (r == null && (a = i(d = o())), u = 0; u <= c; ++u)
...
function ks(t) {
  let n, e, r;
  t.length !== 2 ? (n = ce, e = (s, l) => ce(t(s), l), r = (s, l) => t(s) - l) : (n = t === ce || t === Cd ? t : Id, e = t, r = t);
  function i(s, l, u = 0, c = s.length) {
    if (u < c) {
      if (n(l, l) !== 0) return c;
      do {
...
const jd = ks(ce), Fd = jd.right;
ks(Rd).center;
const Ld = Math.sqrt(50), Dd = Math.sqrt(10), qd = Math.sqrt(2);
function Ne(t, n, e) {
  const r = (n - t) / Math.max(0, e), i = Math.floor(Math.log10(r)), a = r / Math.pow(10, i), o = a >= Ld ? 10 : a >= Dd ? 5 : a >= qd ? 2 : 1;
  let s, l, u;
...
fe.prototype = bi.prototype = {
  constructor: fe,
  on: function(t, n) {
    var e = this._, r = Yd(t + "", e), i, a = -1, o = r.length;
    if (arguments.length < 2) {
      for (; ++a < o; ) if ((i = (t = r[a]).type) && (i = Gd(e[i], t.name))) return i;
      return;
    }
    if (n != null && typeof n != "function") throw new Error("invalid callback: " + n);
    for (; ++a < o; )
      if (i = (t = r[a]).type) e[i] = Ta(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = Ta(e[i], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, n = this._;
...
function Ta(t, n, e) {
  for (var r = 0, i = t.length; r < i; ++r)
    if (t[r].name === n) {
      t[r] = Ud, t = t.slice(0, r).concat(t.slice(r + 1));
      break;
    }
  return e != null && t.push({ name: n, value: e }), t;
}
...
function Ue(t) {
  var n = t += "", e = n.indexOf(":");
  return e >= 0 && (n = t.slice(0, e)) !== "xmlns" && (t = t.slice(e + 1)), ka.hasOwnProperty(n) ? { space: ka[n], local: t } : t;
}
function Vd(t) {
  return function() {
    var n = this.ownerDocument, e = this.namespaceURI;
...
function Ns(t) {
  var n = Ue(t);
  return (n.local ? Kd : Vd)(n);
}
function Zd() {
}
function xi(t) {
  return t == null ? Zd : function() {
    return this.querySelector(t);
  };
}
function Wd(t) {
...
function Ss(t) {
  return t == null ? Qd : function() {
    return this.querySelectorAll(t);
  };
}
function tp(t) {
  return function() {
    return Jd(t.apply(this, arguments));
  };
}
function np(t) {
  typeof t == "function" ? t = tp(t) : t = Ss(t);
  for (var n = this._groups, e = n.length, r = [], i = [], a = 0; a < e; ++a)
    for (var o = n[a], s = o.length, l, u = 0; u < s; ++u)
      (l = o[u]) && (r.push(t.call(l, l.__data__, u, o)), i.push(l));
  return new U(r, i);
...
function ap(t) {
  return this.select(t == null ? ip : rp(typeof t == "function" ? t : Es(t)));
}
var op = Array.prototype.filter;
function sp() {
  return Array.from(this.children);
}
function up(t) {
  return function() {
    return op.call(this.children, t);
  };
}
function lp(t) {
  return this.selectAll(t == null ? sp : up(typeof t == "function" ? t : Es(t)));
}
function cp(t) {
...
function fp() {
  return new U(this._enter || this._groups.map(Os), this._parents);
}
function Se(t, n) {
  this.ownerDocument = t.ownerDocument, this.namespaceURI = t.namespaceURI, this._next = null, this._parent = t, this.__data__ = n;
}
...
function dp(t, n, e, r, i, a) {
  for (var o = 0, s, l = n.length, u = a.length; o < u; ++o)
    (s = n[o]) ? (s.__data__ = a[o], r[o] = s) : e[o] = new Se(t, a[o]);
  for (; o < l; ++o)
    (s = n[o]) && (i[o] = s);
}
function pp(t, n, e, r, i, a, o) {
  var s, l, u = /* @__PURE__ */ new Map(), c = n.length, h = a.length, f = new Array(c), d;
  for (s = 0; s < c; ++s)
    (l = n[s]) && (f[s] = d = o.call(l, l.__data__, s, n) + "", u.has(d) ? i[s] = l : u.set(d, l));
  for (s = 0; s < h; ++s)
    d = o.call(t, a[s], s, a) + "", (l = u.get(d)) ? (r[s] = l, l.__data__ = a[s], u.delete(d)) : e[s] = new Se(t, a[s]);
  for (s = 0; s < c; ++s)
    (l = n[s]) && u.get(f[s]) === l && (i[s] = l);
}
function gp(t) {
...
function _p(t, n) {
  ...
  var e = n ? pp : dp, r = this._parents, i = this._groups;
  typeof t != "function" && (t = hp(t));
  for (var a = i.length, o = new Array(a), s = new Array(a), l = new Array(a), u = 0; u < a; ++u) {
    var c = r[u], h = i[u], f = h.length, d = yp(t.call(c, c && c.__data__, u, r)), g = d.length, y = s[u] = new Array(g), w = o[u] = new Array(g), x = l[u] = new Array(f);
    e(c, h, y, w, x, d, n);
    for (var p = 0, M = 0, _, v; p < g; ++p)
      if (_ = y[p]) {
        for (p >= M && (M = p + 1); !(v = w[M]) && ++M < g; ) ;
...
function mp() {
  return new U(this._exit || this._groups.map(Os), this._parents);
}
function vp(t, n, e) {
  var r = this.enter(), i = this, a = this.exit();
  return typeof t == "function" ? (r = t(r), r && (r = r.selection())) : r = r.append(t + ""), n != null && (i = n(i), i && (i = i.selection())), e == null ? a.remove() : e(a), r && i ? r.merge(i).order() : i;
...
function Rp(t, n) {
  ...
  return this.each((n == null ? e.local ? Ep : Pp : typeof n == "function" ? e.local ? Ip : Cp : e.local ? zp : Op)(e, n));
}
function zs(t) {
  return t.ownerDocument && t.ownerDocument.defaultView || t.document && t || t.defaultView;
}
...
function Dp(t, n, e) {
  return arguments.length > 1 ? this.each((n == null ? jp : typeof n == "function" ? Lp : Fp)(t, n, e ?? "")) : an(this.node(), t);
}
function an(t, n) {
  return t.style.getPropertyValue(n) || zs(t).getComputedStyle(t, null).getPropertyValue(n);
}
function qp(t) {
  return function() {
    delete this[t];
...
function Bp(t, n) {
  return arguments.length > 1 ? this.each((n == null ? qp : typeof n == "function" ? Xp : Hp)(t, n)) : this.node()[t];
}
function Cs(t) {
  return t.trim().split(/^|\s+/);
}
...
function Jp(t) {
  return arguments.length ? this.each(t == null ? Kp : (typeof t == "function" ? Wp : Zp)(t)) : this.node().textContent;
}
function Qp() {
  this.innerHTML = "";
}
...
function e0(t) {
  return arguments.length ? this.each(t == null ? Qp : (typeof t == "function" ? n0 : t0)(t)) : this.node().innerHTML;
}
function r0() {
  this.nextSibling && this.parentNode.appendChild(this);
}
...
function s0(t) {
  var n = typeof t == "function" ? t : Ns(t);
  return this.select(function() {
    return this.appendChild(n.apply(this, arguments));
  });
}
...
function l0(t, n) {
  var e = typeof t == "function" ? t : Ns(t), r = n == null ? u0 : typeof n == "function" ? n : xi(n);
  return this.select(function() {
    return this.insertBefore(e.apply(this, arguments), r.apply(this, arguments) || null);
  });
}
...
function Xn() {
  return new U([[document.documentElement]], Ls);
}
function $0() {
  return this;
}
...
function I(t) {
  return typeof t == "string" ? new U([[document.querySelector(t)]], [document.documentElement]) : new U([[t]], Ls);
}
function T0(t) {
  let n;
...
function Na(t, n) {
  if (t = T0(t), n === void 0 && (n = t.currentTarget), n) {
...
const k0 = { passive: !1 }, On = { capture: !0, passive: !1 };
function mr(t) {
...
function N0(t) {
  var n = t.document.documentElement, e = I(t).on("dragstart.drag", Zt, On);
  "onselectstart" in n ? e.on("selectstart.drag", Zt, On) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none");
}
function S0(t, n) {
  var e = t.document.documentElement, r = I(t).on("dragstart.drag", null);
  n && (r.on("click.drag", Zt, On), setTimeout(function() {
...
function C0() {
  var t = P0, n = E0, e = O0, r = z0, i = {}, a = bi("start", "drag", "end"), o = 0, s, l, u, c, h = 0;
  function f(_) {
    _.on("mousedown.drag", d).filter(r).on("touchstart.drag", w).on("touchmove.drag", x, k0).on("touchend.drag touchcancel.drag", p).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function d(_, v) {
    if (!(c || !t.call(this, _, v))) {
      var N = M(this, n.call(this, _, v), _, v, "mouse");
      N && (I(_.view).on("mousemove.drag", g, On).on("mouseup.drag", y, On), N0(_.view), mr(_), u = !1, s = _.clientX, l = _.clientY, N("start", _));
    }
  }
  function g(_) {
    if (Zt(_), !u) {
  ...
  function y(_) {
    I(_.view).on("mousemove.drag mouseup.drag", null), S0(_.view, u), Zt(_), i.mouse("end", _);
  }
  function w(_, v) {
    if (t.call(this, _, v)) {
      var N = _.changedTouches, T = n.call(this, _, v), z = N.length, L, R;
      for (L = 0; L < z; ++L)
        (R = M(this, T, _, v, N[L].identifier, N[L])) && (mr(_), R("start", _, N[L]));
    }
  }
  function x(_) {
    var v = _.changedTouches, N = v.length, T, z;
    for (T = 0; T < N; ++T)
      (z = i[v[T].identifier]) && (Zt(_), z("drag", _, v[T]));
  }
  function p(_) {
    var v = _.changedTouches, N = v.length, T, z;
    for (c && clearTimeout(c), c = setTimeout(function() {
      ...
      (z = i[v[T].identifier]) && (mr(_), z("end", _, v[T]));
  }
  function M(_, v, N, T, z, L) {
    var R = a.copy(), m = Na(L || N, v), S, $, j;
    if ((j = e.call(_, new Hr("beforestart", {
      sourceEvent: N,
      target: f,
      identifier: z,
      active: o,
      ...
      return S = j.x - m[0] || 0, $ = j.y - m[1] || 0, function Nt(X, Y, V) {
        var C = m, dr;
        switch (X) {
          case "start":
            i[z] = Nt, dr = o++;
...
var zn = 0.7, Pe = 1 / zn, Wt = "\\s*([+-]?\\d+)\\s*", Cn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", it = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", I0 = /^#([0-9a-f]{3,8})$/, R0 = new RegExp(`^rgb\\(${Wt},${Wt},${Wt}\\)$`), j0 = new RegExp(`^rgb\\(${it},${it},${it}\\)$`), F0 = new RegExp(`^rgba\\(${Wt},${Wt},${Wt},${Cn}\\)$`), L0 = new RegExp(`^rgba\\(${it},${it},${it},${Cn}\\)$`), D0 = new RegExp(`^hsl\\(${Cn},${it},${it}\\)$`), q0 = new RegExp(`^hsla\\(${Cn},${it},${it},${Cn}\\)$`), Sa = {
  aliceblue: 15792383,
  antiquewhite: 16444375,
  aqua: 65535,
  aquamarine: 8388564,
...
function jt(t) {
  var n, e;
  return t = (t + "").trim().toLowerCase(), (n = I0.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), e === 6 ? Oa(n) : e === 3 ? new H(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, (n & 15) << 4 | n & 15, 1) : e === 8 ? Qn(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (n & 255) / 255) : e === 4 ? Qn(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | n & 240, ((n & 15) << 4 | n & 15) / 255) : null) : (n = R0.exec(t)) ? new H(n[1], n[2], n[3], 1) : (n = j0.exec(t)) ? new H(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, 1) : (n = F0.exec(t)) ? Qn(n[1], n[2], n[3], n[4]) : (n = L0.exec(t)) ? Qn(n[1] * 255 / 100, n[2] * 255 / 100, n[3] * 255 / 100, n[4]) : (n = D0.exec(t)) ? Ia(n[1], n[2] / 100, n[3] / 100, 1) : (n = q0.exec(t)) ? Ia(n[1], n[2] / 100, n[3] / 100, n[4]) : Sa.hasOwnProperty(t) ? Oa(Sa[t]) : t === "transparent" ? new H(NaN, NaN, NaN, 0) : null;
}
function Oa(t) {
...
function B0(t) {
  return t instanceof Bn || (t = jt(t)), t ? (t = t.rgb(), new H(t.r, t.g, t.b, t.opacity)) : new H();
}
function Xr(t, n, e, r) {
  return arguments.length === 1 ? B0(t) : new H(t, n, e, r ?? 1);
}
function H(t, n, e, r) {
  this.r = +t, this.g = +n, this.b = +e, this.opacity = +r;
}
Ai(H, Xr, Ds(Bn, {
  brighter(t) {
    return t = t == null ? Pe : Math.pow(Pe, t), new H(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  darker(t) {
    return t = t == null ? zn : Math.pow(zn, t), new H(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new H(Ct(this.r), Ct(this.g), Ct(this.b), Ee(this.opacity));
  },
  displayable() {
    return -0.5 <= this.r && this.r < 255.5 && -0.5 <= this.g && this.g < 255.5 && -0.5 <= this.b && this.b < 255.5 && 0 <= this.opacity && this.opacity <= 1;
  },
...
function qs(t) {
  ...
  if (t instanceof Bn || (t = jt(t)), !t) return new J();
...
function Y0(t, n, e, r) {
  return arguments.length === 1 ? qs(t) : new J(t, n, e, r ?? 1);
}
function J(t, n, e, r) {
  this.h = +t, this.s = +n, this.l = +e, this.opacity = +r;
}
Ai(J, Y0, Ds(Bn, {
  ...
  clamp() {
    return new J(Ra(this.h), te(this.s), te(this.l), Ee(this.opacity));
  },
  displayable() {
    return (0 <= this.s && this.s <= 1 || isNaN(this.s)) && 0 <= this.l && this.l <= 1 && 0 <= this.opacity && this.opacity <= 1;
  },
...
function K0(t) {
  return (t = +t) == 1 ? Hs : function(n, e) {
    return e - n ? V0(n, e, t) : $i(isNaN(n) ? e : n);
  };
}
function Hs(t, n) {
  var e = n - t;
  return e ? G0(t, e) : $i(isNaN(t) ? n : t);
}
...
function Xs(t, n) {
  var e = Br.lastIndex = wr.lastIndex = 0, r, i, a, o = -1, s = [], l = [];
  for (t = t + "", n = n + ""; (r = Br.exec(t)) && (i = wr.exec(n)); )
...
function Ti(t, n) {
  var e = typeof n, r;
  return n == null || e === "boolean" ? $i(n) : (e === "number" ? Z : e === "string" ? (r = jt(n)) ? (n = r, Oe) : Xs : n instanceof jt ? Oe : n instanceof Date ? Q0 : W0(n) ? Z0 : Array.isArray(n) ? J0 : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? tg : Z)(t, n);
}
function rg(t, n) {
  return t = +t, n = +n, function(e) {
    return Math.round(t * (1 - e) + n * e);
...
function ig(t) {
  const n = new (typeof DOMMatrix == "function" ? DOMMatrix : WebKitCSSMatrix)(t + "");
  return n.isIdentity ? Bs : Us(n.a, n.b, n.c, n.d, n.e, n.f);
}
function ag(t) {
  return t == null || (ne || (ne = document.createElementNS("http://www.w3.org/2000/svg", "g")), ne.setAttribute("transform", t), !(t = ne.transform.baseVal.consolidate())) ? Bs : (t = t.matrix, Us(t.a, t.b, t.c, t.d, t.e, t.f));
}
function Ys(t, n, e, r) {
  function i(u) {
    return u.length ? u.pop() + " " : "";
  ...
  function a(u, c, h, f, d, g) {
    if (u !== h || c !== f) {
      var y = d.push("translate(", null, n, null, e);
      g.push({ i: y - 4, x: Z(u, h) }, { i: y - 2, x: Z(c, f) });
    } else (h || f) && d.push("translate(" + h + n + f + e);
  }
  function o(u, c, h, f) {
...
var og = Ys(ig, "px, ", "px)", "deg)"), sg = Ys(ag, ", ", ")", ")"), on = 0, Mn = 0, _n = 0, Gs = 1e3, ze, An, Ce = 0, Ft = 0, Ye = 0, In = typeof performance == "object" && performance.now ? performance : Date, Vs = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function ki() {
  return Ft || (Vs(ug), Ft = In.now() + Ye);
}
function ug() {
  Ft = 0;
}
...
Ie.prototype = Ks.prototype = {
  ...
  restart: function(t, n, e) {
    if (typeof t != "function") throw new TypeError("callback is not a function");
    e = (e == null ? ki() : +e) + (n == null ? 0 : +n), !this._next && An !== this && (An ? An._next = this : ze = this, An = this), this._call = t, this._time = e, Ur();
  },
  stop: function() {
...
function Ur(t) {
  if (!on) {
    ...
    var n = t - Ft;
    n > 24 ? (t < 1 / 0 && (Mn = setTimeout(Fa, t - In.now() - Ye)), _n && (_n = clearInterval(_n))) : (_n || (Ce = In.now(), _n = setInterval(cg, Gs)), on = 1, Vs(Fa));
  }
}
function La(t, n, e) {
  var r = new Ie();
...
var hg = bi("start", "end", "cancel", "interrupt"), dg = [], Zs = 0, Da = 1, Yr = 2, he = 3, qa = 4, Gr = 5, de = 6;
...
function pg(t, n, e) {
  ...
  function o(u) {
    ...
    for (c in r)
      if (d = r[c], d.name === e.name) {
        if (d.state === he) return La(o);
        d.state === qa ? (d.state = de, d.timer.stop(), d.on.call("interrupt", t, t.__data__, d.index, d.group), delete r[c]) : +c < n && (d.state = de, d.timer.stop(), d.on.call("cancel", t, t.__data__, d.index, d.group), delete r[c]);
      }
    if (La(function() {
      e.state === he && (e.state = qa, e.timer.restart(s, e.delay, e.time), s(u));
  ...
  function s(u) {
    for (var c = u < e.duration ? e.ease.call(null, u / e.duration) : (e.timer.restart(l), e.state = Gr, 1), h = -1, f = i.length; ++h < f; )
      i[h].call(t, c);
    e.state === Gr && (e.on.call("end", t, t.__data__, e.index, e.group), l());
  }
  function l() {
...
function gg(t, n) {
  ...
  if (e) {
    ...
    for (o in e) {
      ...
      i = r.state > Yr && r.state < Gr, r.state = de, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t, t.__data__, r.index, r.group), delete e[o];
    }
    a && delete t.__transition;
  }
}
...
function Ws(t, n) {
  var e;
  return (typeof n == "number" ? Z : n instanceof jt ? Oe : (e = jt(n)) ? (n = e, Oe) : Xs)(t, n);
}
function wg(t) {
  return function() {
    this.removeAttribute(t);
...
function Tg(t, n) {
  ...
  return this.attrTween(t, typeof n == "function" ? (e.local ? $g : Ag)(e, r, Si(this, "attr." + t, n)) : n == null ? (e.local ? bg : wg)(e) : (e.local ? Mg : xg)(e, r, n));
}
function kg(t, n) {
  return function(e) {
    this.setAttribute(t, n.call(this, e));
...
function Eg(t, n) {
  ...
  if (typeof n != "function") throw new Error();
  var r = Ue(t);
  return this.tween(e, (r.local ? Sg : Pg)(r, n));
}
function Og(t, n) {
  return function() {
    Ni(this, t).delay = +n.apply(this, arguments);
  };
}
function zg(t, n) {
  return n = +n, function() {
...
function Cg(t) {
  var n = this._id;
  return arguments.length ? this.each((typeof t == "function" ? Og : zg)(n, t)) : nt(this.node(), n).delay;
}
function Ig(t, n) {
  return function() {
...
function Lg(t) {
  var n = this._id;
  return arguments.length ? this.each(Fg(n, t)) : nt(this.node(), n).ease;
}
function Dg(t, n) {
  return function() {
    var e = n.apply(this, arguments);
...
function qg(t) {
  if (typeof t != "function") throw new Error();
  return this.each(Dg(this._id, t));
}
function Hg(t) {
  typeof t != "function" && (t = Ps(t));
  for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
...
function Zg(t) {
  ...
  for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s)
    for (var l = r[s], u = l.length, c, h = 0; h < u; ++h)
      if (c = l[h]) {
        for (var f = t.call(c, c.__data__, h, l), d, g = nt(c, e), y = 0, w = f.length; y < w; ++y)
          (d = f[y]) && Ge(d, n, e, y, f, g);
        a.push(f), o.push(c);
      }
  return new pt(a, o, n, e);
}
var Wg = Xn.prototype.constructor;
function Jg() {
...
function r_(t, n, e) {
  ...
  return n == null ? this.styleTween(t, Qg(t, r)).on("end.style." + t, Js(t)) : typeof n == "function" ? this.styleTween(t, n_(t, r, Si(this, "style." + t, n))).each(e_(this._id, t)) : this.styleTween(t, t_(t, r, n), e).on("end.style." + t, null);
}
function i_(t, n, e) {
  return function(r) {
    this.style.setProperty(t, n.call(this, r), e);
...
function l_(t) {
  return this.tween("text", typeof t == "function" ? u_(Si(this, "text", t)) : s_(t == null ? "" : t + ""));
}
function c_(t) {
  return function(n) {
    this.textContent = t.call(this, n);
...
function v_(t) {
  var n, e;
  t instanceof pt ? (n = t._id, t = t._name) : (n = Qs(), (e = y_).time = ki(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, a = 0; a < i; ++a)
    for (var o = r[a], s = o.length, l, u = 0; u < s; ++u)
      (l = o[u]) && Ge(l, t, n, u, o, e || m_(l, n));
  return new pt(r, this._parents, t, n);
}
Xn.prototype.interrupt = _g;
Xn.prototype.transition = v_;
const Vr = Math.PI, Kr = 2 * Vr, Pt = 1e-6, w_ = Kr - Pt;
function tu(t) {
  this._ += t[0];
  for (let n = 1, e = t.length; n < e; ++n)
    this._ += arguments[n] + t[n];
...
class nu {
  ...
  arcTo(n, e, r, i, a) {
    ...
    if (this._x1 === null)
      ...
      let d = r - o, g = i - s, y = l * l + u * u, w = d * d + g * g, x = Math.sqrt(y), p = Math.sqrt(f), M = a * Math.tan((Vr - Math.acos((y + f - w) / (2 * x * p))) / 2), _ = M / p, v = M / x;
      Math.abs(_ - 1) > Pt && this._append`L${n + _ * c},${e + _ * h}`, this._append`A${a},${a},0,0,${+(h * d > c * g)},${this._x1 = n + v * l},${this._y1 = e + v * u}`;
    }
  }
  arc(n, e, r, i, a, o) {
    if (n = +n, e = +e, r = +r, o = !!o, r < 0) throw new Error(`negative radius: ${r}`);
    let s = r * Math.cos(i), l = r * Math.sin(i), u = n + s, c = e + l, h = 1 ^ o, f = o ? i - a : a - i;
    this._x1 === null ? this._append`M${u},${c}` : (Math.abs(this._x1 - u) > Pt || Math.abs(this._y1 - c) > Pt) && this._append`L${u},${c}`, r && (f < 0 && (f = f % Kr + Kr), f > w_ ? this._append`A${r},${r},0,1,${h},${n - s},${e - l}A${r},${r},0,1,${h},${this._x1 = u},${this._y1 = c}` : f > Pt && this._append`A${r},${r},0,${+(f >= Vr)},${h},${this._x1 = n + r * Math.cos(a)},${this._y1 = e + r * Math.sin(a)}`);
  }
  rect(n, e, r, i) {
    this._append`M${this._x0 = this._x1 = +n},${this._y0 = this._y1 = +e}h${r = +r}v${+i}h${-r}Z`;
  }
...
function N_(t) {
  var n = t.grouping === void 0 || t.thousands === void 0 ? Ba : M_(Ua.call(t.grouping, Number), t.thousands + ""), e = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", i = t.decimal === void 0 ? "." : t.decimal + "", a = t.numerals === void 0 ? Ba : A_(Ua.call(t.numerals, String)), o = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", l = t.nan === void 0 ? "NaN" : t.nan + "";
  function u(h) {
    h = je(h);
    var f = h.fill, d = h.align, g = h.sign, y = h.symbol, w = h.zero, x = h.width, p = h.comma, M = h.precision, _ = h.trim, v = h.type;
    v === "n" ? (p = !0, v = "g") : Xa[v] || (M === void 0 && (M = 12), _ = !0, v = "g"), (w || f === "0" && d === "=") && (w = !0, f = "0", d = "=");
    var N = y === "$" ? e : y === "#" && /[boxX]/.test(v) ? "0" + v.toLowerCase() : "", T = y === "$" ? r : /[%p]/.test(v) ? o : "", z = Xa[v], L = /[defgprs%]/.test(v);
    M = M === void 0 ? 6 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, M)) : Math.max(0, Math.min(20, M));
    function R(m) {
      var S = N, $ = T, j, Nt, X;
      if (v === "c")
        ...
        m = +m;
        var Y = m < 0 || 1 / m < 0;
        if (m = isNaN(m) ? l : z(Math.abs(m), M), _ && (m = T_(m)), Y && +m == 0 && g !== "+" && (Y = !1), S = (Y ? g === "(" ? g : s : g === "-" || g === "(" ? "" : g) + S, $ = (v === "s" ? Ya[8 + eu / 3] : "") + $ + (Y && g === "(" ? ")" : ""), L) {
          for (j = -1, Nt = m.length; ++j < Nt; )
            if (X = m.charCodeAt(j), 48 > X || X > 57) {
              $ = (X === 46 ? i + m.slice(j + 1) : m.slice(j)) + $, m = m.slice(0, j);
              break;
  ...
  function c(h, f) {
    var d = u((h = je(h), h.type = "f", h)), g = Math.max(-8, Math.min(8, Math.floor(sn(f) / 3))) * 3, y = Math.pow(10, -g), w = Ya[8 + g / 3];
    return function(x) {
      return d(y * x) + w;
    };
  }
...
function S_(t) {
  return ee = N_(t), Ve = ee.format, ru = ee.formatPrefix, ee;
}
function P_(t) {
...
function j_(t, n, e) {
  var r = t[0], i = t[1], a = n[0], o = n[1];
  return i < r ? (r = Zr(i, r), a = e(o, a)) : (r = Zr(r, i), a = e(a, o)), function(s) {
    return a(r(s));
  };
}
function F_(t, n, e) {
  var r = Math.min(t.length, n.length) - 1, i = new Array(r), a = new Array(r), o = -1;
  for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++o < r; )
    i[o] = Zr(t[o], t[o + 1]), a[o] = e(n[o], n[o + 1]);
  return function(s) {
    var l = Fd(t, s, 1, r) - 1;
    return a[l](i[l](s));
  };
...
function D_() {
  var t = Ga, n = Ga, e = Ti, r, i, a, o = Vt, s, l, u;
  function c() {
    var f = Math.min(t.length, n.length);
    return o !== Vt && (o = R_(t[0], t[f - 1])), s = f > 2 ? F_ : j_, l = u = null, h;
  }
  function h(f) {
    return f == null || isNaN(f = +f) ? a : (l || (l = s(t.map(r), n, e)))(r(o(f)));
  }
...
function H_(t, n, e, r) {
  ...
  switch (r = je(r ?? ",f"), r.type) {
    case "s": {
      var o = Math.max(Math.abs(t), Math.abs(n));
      return r.precision == null && !isNaN(a = E_(i, o)) && (r.precision = a), ru(r, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      r.precision == null && !isNaN(a = O_(i, Math.max(Math.abs(t), Math.abs(n)))) && (r.precision = a - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
      r.precision == null && !isNaN(a = P_(i)) && (r.precision = a - (r.type === "%") * 2);
      break;
    }
  }
  return Ve(r);
...
function X_(t) {
  ...
  return t.ticks = function(e) {
    var r = n();
    return Hd(r[0], r[r.length - 1], e ?? 10);
  }, t.tickFormat = function(e, r) {
    var i = n();
...
$n.prototype;
var iu = typeof global == "object" && global && global.Object === Object && global, B_ = typeof self == "object" && self && self.Object === Object && self, yt = iu || B_ || Function("return this")(), at = yt.Symbol, au = Object.prototype, U_ = au.hasOwnProperty, Y_ = au.toString, yn = at ? at.toStringTag : void 0;
function G_(t) {
...
var hy = "[object AsyncFunction]", dy = "[object Function]", py = "[object GeneratorFunction]", gy = "[object Proxy]";
function uu(t) {
  if (!cn(t))
    return !1;
  var n = hn(t);
  return n == dy || n == py || n == hy || n == gy;
}
...
function dn(t, n) {
  var e = ky(t, n);
  return Ty(e) ? e : void 0;
}
var Wr = dn(yt, "WeakMap"), Ny = 9007199254740991, Sy = /^(?:0|[1-9]\d*)$/;
function Ei(t, n) {
  var e = typeof t;
  return n = n ?? Ny, !!n && (e == "number" || e != "symbol" && Sy.test(t)) && t > -1 && t % 1 == 0 && t < n;
}
function Oi(t, n) {
  return t === n || t !== t && n !== n;
}
...
function Ze(t) {
  return t != null && zi(t.length) && !uu(t);
}
function Ey(t, n, e) {
  if (!cn(e))
    return !1;
...
var lu = Object.prototype, Ry = lu.hasOwnProperty, jy = lu.propertyIsEnumerable, Ci = Qa(/* @__PURE__ */ function() {
  return arguments;
}()) ? Qa : function(t) {
...
var cu = typeof exports == "object" && exports && !exports.nodeType && exports, to = cu && typeof module == "object" && module && !module.nodeType && module, Ly = to && to.exports === cu, no = Ly ? yt.Buffer : void 0, Dy = no ? no.isBuffer : void 0, Jr = Dy || Fy, qy = "[object Arguments]", Hy = "[object Array]", Xy = "[object Boolean]", By = "[object Date]", Uy = "[object Error]", Yy = "[object Function]", Gy = "[object Map]", Vy = "[object Number]", Ky = "[object Object]", Zy = "[object RegExp]", Wy = "[object Set]", Jy = "[object String]", Qy = "[object WeakMap]", tm = "[object ArrayBuffer]", nm = "[object DataView]", em = "[object Float32Array]", rm = "[object Float64Array]", im = "[object Int8Array]", am = "[object Int16Array]", om = "[object Int32Array]", sm = "[object Uint8Array]", um = "[object Uint8ClampedArray]", lm = "[object Uint16Array]", cm = "[object Uint32Array]", P = {};
P[em] = P[rm] = P[im] = P[am] = P[om] = P[sm] = P[um] = P[lm] = P[cm] = !0;
P[qy] = P[Hy] = P[tm] = P[Xy] = P[nm] = P[By] = P[Uy] = P[Yy] = P[Gy] = P[Vy] = P[Ky] = P[Zy] = P[Wy] = P[Jy] = P[Qy] = !1;
function fm(t) {
  return ln(t) && zi(t.length) && !!P[hn(t)];
}
function hm(t) {
  return function(n) {
    return t(n);
...
var fu = typeof exports == "object" && exports && !exports.nodeType && exports, Tn = fu && typeof module == "object" && module && !module.nodeType && module, dm = Tn && Tn.exports === fu, Mr = dm && iu.process, eo = function() {
  try {
    var t = Tn && Tn.require && Tn.require("util").types;
    return t || Mr && Mr.binding && Mr.binding("util");
  } catch {
  }
}(), ro = eo && eo.isTypedArray, hu = ro ? hm(ro) : fm, pm = Object.prototype, gm = pm.hasOwnProperty;
function _m(t, n) {
  var e = Q(t), r = !e && Ci(t), i = !e && !r && Jr(t), a = !e && !r && !i && hu(t), o = e || r || i || a, s = o ? Cy(t.length, String) : [], l = s.length;
  for (var u in t)
...
var Tm = "__lodash_hash_undefined__", km = Object.prototype, Nm = km.hasOwnProperty;
function Sm(t) {
  var n = this.__data__;
  if (Rn) {
    var e = n[t];
    return e === Tm ? void 0 : e;
  }
  return Nm.call(n, t) ? n[t] : void 0;
}
var Pm = Object.prototype, Em = Pm.hasOwnProperty;
function Om(t) {
  var n = this.__data__;
  return Rn ? n[t] !== void 0 : Em.call(n, t);
}
var zm = "__lodash_hash_undefined__";
function Cm(t, n) {
  var e = this.__data__;
  return this.size += this.has(t) ? 0 : 1, e[t] = Rn && n === void 0 ? zm : n, this;
}
function Lt(t) {
...
Lt.prototype.clear = Am;
Lt.prototype.delete = $m;
Lt.prototype.get = Sm;
Lt.prototype.has = Om;
Lt.prototype.set = Cm;
function Im() {
...
function Je(t, n) {
  var e = t.__data__;
  return Xm(n) ? e[typeof n == "string" ? "string" : "hash"] : e.map;
}
function Bm(t) {
...
function ji(t, n) {
  ...
  return e.cache = new (ji.Cache || vt)(), e;
}
ji.Cache = vt;
var Km = 500;
function Zm(t) {
...
var dv = Object.prototype, pv = dv.propertyIsEnumerable, ao = Object.getOwnPropertySymbols, gv = ao ? function(t) {
...
var Qr = dn(yt, "DataView"), ti = dn(yt, "Promise"), ni = dn(yt, "Set"), so = "[object Map]", yv = "[object Object]", uo = "[object Promise]", lo = "[object Set]", co = "[object WeakMap]", fo = "[object DataView]", mv = Ht(Qr), vv = Ht(jn), wv = Ht(ti), bv = Ht(ni), xv = Ht(Wr), Mt = hn;
(Qr && Mt(new Qr(new ArrayBuffer(1))) != fo || jn && Mt(new jn()) != so || ti && Mt(ti.resolve()) != uo || ni && Mt(new ni()) != lo || Wr && Mt(new Wr()) != co) && (Mt = function(t) {
...
Fe.prototype.add = Fe.prototype.push = Av;
Fe.prototype.has = $v;
function Tv(t, n) {
...
function _u(t, n, e, r, i, a) {
  var o = e & Nv, s = t.length, l = n.length;
  if (s != l && !(o && l > s))
    return !1;
  var u = a.get(t), c = a.get(n);
  if (u && c)
    return u == n && c == t;
  var h = -1, f = !0, d = e & Sv ? new Fe() : void 0;
  for (a.set(t, n), a.set(n, t); ++h < s; ) {
    var g = t[h], y = n[h];
    if (r)
      var w = o ? r(y, g, h, n, t, a) : r(g, y, h, t, n, a);
    if (w !== void 0) {
      if (w)
        continue;
      f = !1;
    ...
    if (d) {
      if (!Tv(n, function(x, p) {
        if (!kv(d, p) && (g === x || i(g, x, e, r, a)))
          return d.push(p);
      })) {
        f = !1;
        break;
...
var Ov = 1, zv = 2, Cv = "[object Boolean]", Iv = "[object Date]", Rv = "[object Error]", jv = "[object Map]", Fv = "[object Number]", Lv = "[object RegExp]", Dv = "[object Set]", qv = "[object String]", Hv = "[object Symbol]", Xv = "[object ArrayBuffer]", Bv = "[object DataView]", po = at ? at.prototype : void 0, Ar = po ? po.valueOf : void 0;
...
function Kv(t, n, e, r, i, a) {
  ...
  for (var w = o; ++h < l; ) {
    ...
    var x = t[f], p = n[f];
    if (r)
      var M = o ? r(p, x, f, n, t, a) : r(x, p, f, t, n, a);
    if (!(M === void 0 ? x === p || i(x, p, e, r, a) : M)) {
      y = !1;
      break;
    }
    w || (w = f == "constructor");
...
function Jv(t, n, e, r, i, a) {
  ...
  if (!(e & Zv)) {
    var d = c && yo.call(t, "__wrapped__"), g = h && yo.call(n, "__wrapped__");
    if (d || g) {
      var y = d ? t.value() : t, w = g ? n.value() : n;
...
function a1(t, n, e) {
  ...
  return a || ++r != i ? a : (i = t == null ? 0 : t.length, !!i && zi(i) && Ei(o, i) && (Q(t) || Ci(t)));
}
function o1(t, n) {
...
var s1 = 1, u1 = 2;
function l1(t, n) {
  return Ri(t) && yu(n) ? mu(Qe(t), n) : function(e) {
    var r = nv(e, t);
...
function M1(t) {
  return function(n, e, r) {
    return r && typeof r != "number" && Ey(n, e, r) && (e = r = void 0), n = br(n), e === void 0 ? (e = n, n = 0) : e = br(e), r = r === void 0 ? n < e ? 1 : -1 : br(r), x1(n, e, r);
  };
}
var A1 = M1();
const $1 = (t, n, e = 12, r = 12) => {
...
}, T1 = "_widget_9wct0_49", k1 = "_label_9wct0_69", N1 = "_lit_9wct0_74", S1 = "_button_9wct0_78", P1 = "_symbol_9wct0_78", E1 = "_radio_9wct0_79", O1 = "_radiobutton_9wct0_79", z1 = "_selected_9wct0_85", C1 = "_toggle_9wct0_86", I1 = "_slider_9wct0_95", R1 = "_track_9wct0_95", j1 = "_track_overlay_9wct0_100", F1 = "_handle_9wct0_108", A = {
  widget: T1,
  label: k1,
  lit: N1,
  button: S1,
  ...
  return {
    ...
    click: function() {
      h = (h + 1) % c.length, u(), I(this.parentNode).select("." + A.symbol).attr("d", ei(c[h])(r * e));
    },
    press: function(f) {
      h = (h + 1) % c.length, u(), f.select("#button_" + n).select("." + A.symbol).attr("d", ei(c[h])(r * e));
    }
  };
}, V1 = () => {
  const t = "slider", n = Ve(".3f");
  var e = tr(), r = 100, i = 8, a = 10, o = !1, s = { x: 0, y: 0 }, l = "top-left", u = 4, c = null, h = function(p) {
  }, f = function(p) {
  }, d = [0, 1], g = 0, y = null, w = un().domain(d).range([0, r]).clamp(!0);
  const x = function(p, M, _ = d) {
    const v = p.select("#slider_" + e);
    w.domain(_), g = M, v.selectAll("." + A.handle).transition().attr("cx", w(M)), o && v.select("." + A.label).text(y + " = " + n(g)), h(), f();
  };
  return {
    type: t,
    scale: w,
  ...
  return {
    ...
    click: function() {
      ...
      u.select("." + A.handle).transition().attr("cx", l ? 2 * e : 0), u.classed(A.selected, l), s();
    },
    reset: function(u, c) {
      l = c;
      const h = u.select("#toggle_" + n);
      h.selectAll("." + A.handle).transition().attr("cx", l ? 2 * e : 0), h.classed(A.selected, l), s();
    }
  };
}, Z1 = () => {
  const t = "radio";
  var n = tr(), e = 100, r = 20, i = 0.3, a = "round", o = "vertical", s = { x: 0, y: 0 }, l = "right", u = null, c = function(d) {
  }, h = [], f = 0;
  return {
    type: t,
    id: function(d) {
    ...
    click: function(d, g) {
      f = g, I(this.parentNode).selectAll("." + A.symbol).classed(A.selected, (y) => y == f), c();
    },
    reset: function(d, g) {
      f = g, d.select("#radio_" + n).selectAll("." + A.symbol).classed(A.selected, (y) => y == f), c();
    }
  };
}, W1 = (t, n) => {
  const e = "button_" + t.id(), r = t.label(), i = t.labelposition(), a = document.createElementNS("http://www.w3.org/2000/svg", "g"), o = I(a).attr("class", A.widget + " " + A.button).attr("id", e).attr("transform", "translate(" + t.x() + "," + t.y() + ")");
  var s;
  if (t.shape() == "rect" ? s = o.append("rect").attr("width", t.size()).attr("height", t.size()).attr("transform", "translate(" + -t.size() / 2 + "," + -t.size() / 2 + ")").attr("rx", 5).attr("ry", 5) : s = o.append("circle").attr("r", t.size() / 2), s.attr("class", A.background).on("click", t.click).on("mouseover", function() {
    I(this).classed(A.lit, !0), I(this.parentNode).select("." + A.symbol).classed(A.lit, !0);
  }).on("mouseout", function() {
    I(this).classed(A.lit, !1), I(this.parentNode).select("." + A.symbol).classed(A.lit, !1);
  }), o.append("path").attr("d", ei(t.actions()[t.value()])(t.symbolsize() * t.size())).attr("class", A.symbol), r) {
    const l = Li(t.size(), t.size(), i);
    o.append("text").text(r).attr("class", A.label).style("text-anchor", l.anchor).style("font-size", t.fontsize()).style("alignment-baseline", l.valign).attr("transform", "translate(" + l.x + "," + l.y + ")");
  }
  return a;
}, vu = (t, n) => {
  const e = et();
  ...
  s = I(l).attr("class", A.widget + " " + A.slider).attr("id", r).attr("transform", "translate(" + t.x() + "," + t.y() + ")"), o.domain(i()).range([0, a]).clamp(!0);
  const u = t.knob() > t.girth() ? t.knob() : t.girth() / 2, c = (x) => {
    ...
    const _ = p.getBoundingClientRect(), v = M - _.left, N = p.width && p.width.baseVal ? p.width.baseVal.value : _.width, T = _.width ? N / _.width : 1;
    return v * T - u;
  };
  s.append("path").attr("d", vu(t.size(), t.girth())).attr("class", A.track), s.append("circle").attr("class", A.handle).attr("r", t.knob()).attr("cx", o(t.value())), s.append("rect").attr("width", t.size() + 2 * u).attr("height", 2 * u).attr("transform", "translate(" + -u + "," + -u + ")").attr("class", A.track_overlay).on("click", function(x) {
    const p = h(x, this);
    if (p == null) return;
    const M = Math.max(0, Math.min(t.size(), p));
    t.value(o.invert(M)), t.update(), t.update_end(), s.selectAll("." + A.handle).attr("cx", o(t.value())), t.show() && s.select("." + A.label).text(t.label() + " = " + e(t.value()));
  }).call(
    C0().on("drag", function(x) {
      const p = h(x, this);
      if (p == null) return;
      const M = Math.max(0, Math.min(t.size(), p));
      t.value(o.invert(M)), t.update(), s.selectAll("." + A.handle).attr("cx", o(t.value())), t.show() && s.select("." + A.label).text(t.label() + " = " + e(t.value()));
    }).on("end", function(x) {
      t.update_end();
    })
  );
  ...
  return t.fontsize ? d = t.labelposition().match(/bottom/i) != null ? Wn([t.girth() / 2, t.knob()]) + t.fontsize() / 2 + w : -Wn([t.girth() / 2, t.knob()]) - t.fontsize() / 2 - w : d = t.labelposition().match(/bottom/i) != null ? Wn([t.girth() / 2, t.knob()]) + 7 + w : -Wn([t.girth() / 2, t.knob()]) - 7 - w, f = t.labelposition().match(/right/i) != null ? t.size() : t.labelposition().match(/center/i) != null ? t.size() / 2 : 0, g = t.labelposition().match(/right/i) != null ? "end" : t.labelposition().match(/center/i) != null ? "middle" : "start", y = t.labelposition().match(/bottom/i) != null ? "hanging" : "top", s.append("text").text(t.show() ? t.label() + " = " + e(t.value()) : t.label()).attr("class", A.label).style("text-anchor", g).style("alignment-baseline", y).style("font-size", t.fontsize()).style("opacity", 1).attr("transform", "translate(" + f + "," + d + ")"), l;
}, Q1 = (t, n) => {
  const e = "toggle_" + t.id(), r = t.size(), i = t.label(), a = t.labelposition(), o = document.createElementNS("http://www.w3.org/2000/svg", "g"), s = I(o).attr("class", A.widget + " " + A.toggle).attr("id", e).attr("transform", "translate(" + (t.x() - r) + "," + t.y() + ")").classed(A.selected, t.value() == 1);
  if (s.append("path").attr("d", vu(2 * t.size(), 2 * t.size())).attr("class", A.track), s.append("circle").attr("class", A.handle).attr("r", r).attr("cx", t.value() ? 2 * r : 0), s.append("rect").attr("width", 4 * t.size()).attr("height", 2 * t.size()).attr("class", A.track_overlay).attr("transform", "translate(" + -t.size() + "," + -t.size() + ")").on("click", t.click), i) {
    const l = Li(4 * t.size(), 2 * t.size(), a);
    s.append("text").text(i).attr("class", A.label).style("text-anchor", l.anchor).style("font-size", t.fontsize()).style("alignment-baseline", l.valign).attr("transform", "translate(" + (l.x + r) + "," + l.y + ")");
  }
  return o;
}, tw = (t, n) => {
  const e = "radio_" + t.id(), r = t.labelposition(), i = t.buttonsize(), a = t.buttonsize() * (1 - t.buttonpadding()), o = t.choices().length, s = Bd(o), l = un().domain([0, o - 1]).range([0, t.size()]), u = un().domain([0, o - 1]).range([0, t.size()]), c = document.createElementNS("http://www.w3.org/2000/svg", "g"), h = I(c).attr("class", A.widget + " " + A.radio).attr("id", e).attr("transform", "translate(" + t.x() + "," + t.y() + ")").selectAll("." + A.radiobutton).data(s).enter().append("g").attr("class", A.radiobutton).attr("id", (y) => "b" + y).attr("transform", (y) => t.orientation() == "vertical" ? "translate(0," + u(y) + ")" : "translate(" + l(y) + ",0)");
  var f, d;
  t.shape() == "rect" ? (f = h.append("rect").attr("width", i).attr("height", i).attr("rx", 2).attr("ry", 2).attr("transform", "translate(" + -i / 2 + "," + -i / 2 + ")"), d = h.append("rect").attr("width", a).attr("height", a).attr("rx", 2).attr("ry", 2).attr("transform", "translate(" + -a / 2 + "," + -a / 2 + ")")) : (f = h.append("circle").attr("r", i / 2), d = h.append("circle").attr("r", a / 2)), f.attr("class", A.background).on("mouseover", function() {
    I(this).classed(A.lit, !0), I(this.parentNode).select("." + A.symbol).classed(A.lit, !0);
  }).on("mouseout", function() {
    I(this).classed(A.lit, !1), I(this.parentNode).select("." + A.symbol).classed(A.lit, !1);
  }), d.attr("class", A.symbol), d.filter((y) => y == t.value()).classed(A.selected, !0), h.on("click", t.click);
  const g = Li(t.buttonsize(), t.buttonsize(), r);
  return h.append("text").attr("class", A.label).text(function(y, w) {
    return t.choices()[w];
...
}, nw = "_agent_xh8l1_1", ew = "_inset_xh8l1_7", rw = "_plot_xh8l1_11", iw = "_xaxis_xh8l1_15", aw = "_yaxis_xh8l1_18", ow = "_xlabel_xh8l1_22", sw = "_ylabel_xh8l1_25", uw = "_caxis_xh8l1_28", lw = "_dot_xh8l1_34", cw = "_op_xh8l1_40", fw = "_plotline_xh8l1_46", hw = "_displayPanel_xh8l1_88", dw = "_controlPanel_xh8l1_95", O = {
  agent: nw,
  inset: ew,
  plot: rw,
  xaxis: iw,
  ...
  const e = $1(
    ...
    n.controls_grid.nx,
    n.controls_grid.ny
  ), r = sf("#" + t).classed(t + " " + n.container_class, !0), i = t + "_display", a = t + "_controls", o = r.append("div").attr("id", i).attr("class", O.displayPanel).classed(n.display_class, !0).classed(n.debug_lattice, n.debug).append(n.display_type).attr("width", n.display_type == "canvas" ? n.display_size.width : null).attr("height", n.display_type == "canvas" ? n.display_size.height : null).attr("viewBox", n.display_type == "canvas" ? null : "0 0 " + n.display_size.width + " " + n.display_size.height).style("width", "100%"), s = r.append("div").attr("id", a).attr("class", "d3-widgets " + O.controlPanel).classed(n.controls_class, !0).classed(n.debug_lattice, n.debug).append("svg").attr("viewBox", "0 0 " + n.controls_size.width + " " + n.controls_size.height).style("width", "100%").style("height", "100%");
...
function nr(t) {
  return typeof t == "symbol" || Dt(t) && Xt(t) == Aw;
}
function er(t, n) {
  for (var e = -1, r = t == null ? 0 : t.length, i = Array(r); ++e < r; )
    i[e] = n(t[e], e, t);
...
var kw = /^\s+/;
function Nw(t) {
  return t && t.slice(0, Tw(t) + 1).replace(kw, "");
}
function gt(t) {
  var n = typeof t;
  return t != null && (n == "object" || n == "function");
}
var xo = NaN, Sw = /^[-+]0x[0-9a-f]+$/i, Pw = /^0b[01]+$/i, Ew = /^0o[0-7]+$/i, Ow = parseInt;
function zw(t) {
  if (typeof t == "number")
    return t;
  if (nr(t))
  ...
  t = Nw(t);
  var e = Pw.test(t);
  return e || Ew.test(t) ? Ow(t.slice(2), e ? 2 : 8) : Sw.test(t) ? xo : +t;
}
var Cw = 1 / 0, Iw = 17976931348623157e292;
function $r(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = zw(t), t === Cw || t === -1 / 0) {
    var n = t < 0 ? -1 : 1;
    return n * Iw;
  }
  return t === t ? t : 0;
...
var Rw = "[object AsyncFunction]", jw = "[object Function]", Fw = "[object GeneratorFunction]", Lw = "[object Proxy]";
function Au(t) {
  if (!gt(t))
    return !1;
  var n = Xt(t);
  return n == jw || n == Fw || n == Rw || n == Lw;
}
var Tr = wt["__core-js_shared__"], Mo = function() {
...
var qw = Function.prototype, Hw = qw.toString;
function Bt(t) {
  if (t != null) {
    try {
      return Hw.call(t);
...
var Xw = /[\\^$.*+?()[\]{}|]/g, Bw = /^\[object .+?Constructor\]$/, Uw = Function.prototype, Yw = Object.prototype, Gw = Uw.toString, Vw = Yw.hasOwnProperty, Kw = RegExp(
  "^" + Gw.call(Vw).replace(Xw, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Zw(t) {
  if (!gt(t) || Dw(t))
    return !1;
...
var ri = Ut(wt, "WeakMap"), Ao = function() {
  try {
...
function Un(t) {
  return t != null && qi(t.length) && !Au(t);
}
function ob(t, n, e) {
  if (!gt(e))
    return !1;
...
var Tu = Object.prototype, cb = Tu.hasOwnProperty, fb = Tu.propertyIsEnumerable, ku = $o(/* @__PURE__ */ function() {
  return arguments;
}()) ? $o : function(t) {
  return Dt(t) && cb.call(t, "callee") && !fb.call(t, "callee");
};
function hb() {
  return !1;
}
var Nu = typeof exports == "object" && exports && !exports.nodeType && exports, To = Nu && typeof module == "object" && module && !module.nodeType && module, db = To && To.exports === Nu, ko = db ? wt.Buffer : void 0, pb = ko ? ko.isBuffer : void 0, ii = pb || hb, gb = "[object Arguments]", _b = "[object Array]", yb = "[object Boolean]", mb = "[object Date]", vb = "[object Error]", wb = "[object Function]", bb = "[object Map]", xb = "[object Number]", Mb = "[object Object]", Ab = "[object RegExp]", $b = "[object Set]", Tb = "[object String]", kb = "[object WeakMap]", Nb = "[object ArrayBuffer]", Sb = "[object DataView]", Pb = "[object Float32Array]", Eb = "[object Float64Array]", Ob = "[object Int8Array]", zb = "[object Int16Array]", Cb = "[object Int32Array]", Ib = "[object Uint8Array]", Rb = "[object Uint8ClampedArray]", jb = "[object Uint16Array]", Fb = "[object Uint32Array]", E = {};
E[Pb] = E[Eb] = E[Ob] = E[zb] = E[Cb] = E[Ib] = E[Rb] = E[jb] = E[Fb] = !0;
E[gb] = E[_b] = E[Nb] = E[yb] = E[Sb] = E[mb] = E[vb] = E[wb] = E[bb] = E[xb] = E[Mb] = E[Ab] = E[$b] = E[Tb] = E[kb] = !1;
function Lb(t) {
  return Dt(t) && qi(t.length) && !!E[Xt(t)];
}
function Db(t) {
  return function(n) {
    return t(n);
...
var Su = typeof exports == "object" && exports && !exports.nodeType && exports, kn = Su && typeof module == "object" && module && !module.nodeType && module, qb = kn && kn.exports === Su, kr = qb && wu.process, No = function() {
  try {
    var t = kn && kn.require && kn.require("util").types;
    return t || kr && kr.binding && kr.binding("util");
  } catch {
  }
}(), So = No && No.isTypedArray, Pu = So ? Db(So) : Lb, Hb = Object.prototype, Xb = Hb.hasOwnProperty;
function Eu(t, n) {
  var e = G(t), r = !e && ku(t), i = !e && !r && ii(t), a = !e && !r && !i && Pu(t), o = e || r || i || a, s = o ? ub(t.length, String) : [], l = s.length;
  for (var u in t)
    (n || Xb.call(t, u)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
    (u == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
    i && (u == "offset" || u == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    a && (u == "buffer" || u == "byteLength" || u == "byteOffset") || // Skip index properties.
    rr(u, l))) && s.push(u);
...
var Bb = Ou(Object.keys, Object), Ub = Object.prototype, Yb = Ub.hasOwnProperty;
function Gb(t) {
  if (!$u(t))
    return Bb(t);
  var n = [];
...
function lx(t) {
  var n = this.__data__;
  return Fn ? n[t] !== void 0 : ux.call(n, t);
}
var cx = "__lodash_hash_undefined__";
function fx(t, n) {
  var e = this.__data__;
  return this.size += this.has(t) ? 0 : 1, e[t] = Fn && n === void 0 ? cx : n, this;
}
function qt(t) {
  var n = -1, e = t == null ? 0 : t.length;
  for (this.clear(); ++n < e; ) {
...
qt.prototype.clear = nx;
qt.prototype.delete = ex;
qt.prototype.get = ox;
qt.prototype.has = lx;
qt.prototype.set = fx;
function hx() {
...
var dx = Array.prototype, px = dx.splice;
function gx(t) {
  var n = this.__data__, e = or(n, t);
  if (e < 0)
    return !1;
  var r = n.length - 1;
  return e == r ? n.pop() : px.call(n, e, 1), --this.size, !0;
}
function _x(t) {
  var n = this.__data__, e = or(n, t);
  return e < 0 ? void 0 : n[e][1];
...
var Nx = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Sx = /\\(\\)?/g, Px = kx(function(t) {
  var n = [];
  return t.charCodeAt(0) === 46 && n.push(""), t.replace(Nx, function(e, r, i, a) {
...
var Ox = Ou(Object.getPrototypeOf, Object);
function zx(t, n, e) {
  var r = -1, i = t.length;
...
function Cx(t, n, e) {
  var r = t.length;
  return e = e === void 0 ? r : e, zx(t, n, e);
}
var Ix = "\\ud800-\\udfff", Rx = "\\u0300-\\u036f", jx = "\\ufe20-\\ufe2f", Fx = "\\u20d0-\\u20ff", Lx = Rx + jx + Fx, Dx = "\\ufe0e\\ufe0f", qx = "\\u200d", Hx = RegExp("[" + qx + Ix + Lx + Dx + "]");
function Cu(t) {
  return Hx.test(t);
}
function Xx(t) {
...
var Iu = "\\ud800-\\udfff", Bx = "\\u0300-\\u036f", Ux = "\\ufe20-\\ufe2f", Yx = "\\u20d0-\\u20ff", Gx = Bx + Ux + Yx, Vx = "\\ufe0e\\ufe0f", Kx = "[" + Iu + "]", ai = "[" + Gx + "]", oi = "\\ud83c[\\udffb-\\udfff]", Zx = "(?:" + ai + "|" + oi + ")", Ru = "[^" + Iu + "]", ju = "(?:\\ud83c[\\udde6-\\uddff]){2}", Fu = "[\\ud800-\\udbff][\\udc00-\\udfff]", Wx = "\\u200d", Lu = Zx + "?", Du = "[" + Vx + "]?", Jx = "(?:" + Wx + "(?:" + [Ru, ju, Fu].join("|") + ")" + Du + Lu + ")*", Qx = Du + Lu + Jx, t2 = "(?:" + [Ru + ai + "?", ai, ju, Fu, Kx].join("|") + ")", n2 = RegExp(oi + "(?=" + oi + ")|" + t2 + Qx, "g");
function e2(t) {
  return t.match(n2) || [];
}
function r2(t) {
  return Cu(t) ? e2(t) : Xx(t);
}
function i2(t) {
  return function(n) {
    n = ur(n);
...
var d2 = Object.prototype, p2 = d2.propertyIsEnumerable, Po = Object.getOwnPropertySymbols, Xu = Po ? function(t) {
  return t == null ? [] : (t = Object(t), qu(Po(t), function(n) {
    return p2.call(t, n);
  }));
...
var si = Ut(wt, "DataView"), ui = Ut(wt, "Promise"), li = Ut(wt, "Set"), Oo = "[object Map]", m2 = "[object Object]", zo = "[object Promise]", Co = "[object Set]", Io = "[object WeakMap]", Ro = "[object DataView]", v2 = Bt(si), w2 = Bt(Ln), b2 = Bt(ui), x2 = Bt(li), M2 = Bt(ri), ct = Xt;
(si && ct(new si(new ArrayBuffer(1))) != Ro || Ln && ct(new Ln()) != Oo || ui && ct(ui.resolve()) != zo || li && ct(new li()) != Co || ri && ct(new ri()) != Io) && (ct = function(t) {
  var n = Xt(t), e = n == m2 ? t.constructor : void 0, r = e ? Bt(e) : "";
  if (r)
    switch (r) {
      case v2:
        return Ro;
...
Le.prototype.add = Le.prototype.push = $2;
Le.prototype.has = T2;
function k2(t, n) {
  for (var e = -1, r = t == null ? 0 : t.length; ++e < r; )
    if (n(t[e], e, t))
...
function Uu(t, n, e, r, i, a) {
  ...
  if (u && c)
    return u == n && c == t;
  var h = -1, f = !0, d = e & P2 ? new Le() : void 0;
  for (a.set(t, n), a.set(n, t); ++h < s; ) {
    var g = t[h], y = n[h];
    if (r)
      var w = o ? r(y, g, h, n, t, a) : r(g, y, h, t, n, a);
    ...
    if (d) {
      if (!k2(n, function(x, p) {
        if (!N2(d, p) && (g === x || i(g, x, e, r, a)))
          return d.push(p);
      })) {
        f = !1;
        break;
...
var O2 = 1, z2 = 2, C2 = "[object Boolean]", I2 = "[object Date]", R2 = "[object Error]", j2 = "[object Map]", F2 = "[object Number]", L2 = "[object RegExp]", D2 = "[object Set]", q2 = "[object String]", H2 = "[object Symbol]", X2 = "[object ArrayBuffer]", B2 = "[object DataView]", Fo = kt ? kt.prototype : void 0, Nr = Fo ? Fo.valueOf : void 0;
function U2(t, n, e, r, i, a, o) {
  switch (e) {
    ...
    case H2:
      if (Nr)
        return Nr.call(t) == Nr.call(n);
  }
  return !1;
}
var Y2 = 1, G2 = Object.prototype, V2 = G2.hasOwnProperty;
function K2(t, n, e, r, i, a) {
  var o = e & Y2, s = Eo(t), l = s.length, u = Eo(n), c = u.length;
  if (l != c && !o)
    return !1;
  for (var h = l; h--; ) {
    var f = s[h];
...
var Z2 = 1, Lo = "[object Arguments]", Do = "[object Array]", ae = "[object Object]", W2 = Object.prototype, qo = W2.hasOwnProperty;
function J2(t, n, e, r, i, a) {
  var o = G(t), s = G(n), l = o ? Do : ct(t), u = s ? Do : ct(n);
  l = l == Lo ? ae : l, u = u == Lo ? ae : u;
  ...
  if (f && !c)
    return a || (a = new ht()), o || Pu(t) ? Uu(t, n, e, r, i, a) : U2(t, n, l, e, r, i, a);
  if (!(e & Z2)) {
    var d = c && qo.call(t, "__wrapped__"), g = h && qo.call(n, "__wrapped__");
    if (d || g) {
      var y = d ? t.value() : t, w = g ? n.value() : n;
...
function Ui(t, n, e, r, i) {
  return t === n ? !0 : t == null || n == null || !Dt(t) && !Dt(n) ? t !== t && n !== n : J2(t, n, e, r, Ui, i);
}
var Q2 = 1, tM = 2;
function nM(t, n, e, r) {
  var i = e.length, a = i;
  ...
  for (; ++i < a; ) {
    ...
    if (o[2]) {
      ...
      var c = new ht(), h;
      if (!(h === void 0 ? Ui(u, l, Q2 | tM, r, c) : h))
        return !1;
    }
  }
  return !0;
...
function Ku(t, n, e) {
  ...
  return a || ++r != i ? a : (i = t == null ? 0 : t.length, !!i && qi(i) && rr(o, i) && (G(t) || ku(t)));
}
function aM(t, n) {
...
var oM = 1, sM = 2;
function uM(t, n) {
  return Hi(t) && Gu(n) ? Vu(Yn(t), n) : function(e) {
    var r = Ex(e, t);
    return r === void 0 && r === n ? aM(e, t) : Ui(n, r, oM | sM);
  };
}
function lM(t) {
  return function(n) {
...
function Ju(t, n) {
  return t != null && Ku(t, n, TM);
}
var kM = "[object Boolean]";
function NM(t) {
  return t === !0 || t === !1 || Dt(t) && Xt(t) == kM;
}
function SM(t, n) {
...
function Gi(t, n) {
  ...
  return n = cr(n), zM(t, e, function(r, i) {
    return n(r, i[0]);
  });
}
...
const k = {
  ...
  n[1].id = n[0], n[1].label == null && (n[1].label = FM(o2(n[0]), /_/g, " "));
}), Ki = (t) => pn(Zu(t), (n) => n[1]), Zi = (t, n) => Tt(t, (e, r) => e.widget = n[r]), LM = (t) => Gi(t, (n) => Ju(n, "range")), DM = (t) => Gi(t, (n) => NM(n.default)), qM = (t) => Gi(t, (n) => Ju(n, "choices"));
_t().domain([0, 360]).range([0, 2 * Math.PI]);
_t().range([0, 360]).domain([0, 2 * Math.PI]);
const Wi = LM(b), Ji = DM(b), Qi = qM(b);
Vi(Wi);
Vi(Ji);
Vi(Qi);
const Qu = Ki(Wi), tl = Ki(Ji), nl = Ki(Qi), pe = pn(
  Qu,
  (t) => V1().id(t.id).label(t.label).range(t.range).value(t.default).size(k.widgets.slider_size)
), ge = pn(
  tl,
  (t) => K1().id(t.id).label(t.label).value(t.default).labelposition(k.widgets.toggle_label_pos)
), fi = pn(
  nl,
  (t) => Z1().choices(t.choices).id(t.id).value(t.default).labelposition(k.widgets.radio_label_position)
);
Zi(tl, ge);
Zi(Qu, pe);
Zi(nl, fi);
const At = Di().actions(["play", "pause"]), fr = Di().actions(["back"]), hr = Di().actions(["rewind"]), HM = [At, fr, hr], XM = (t, n) => {
  const e = n.position(k.widgets.slider_anchor.x, ci(pe.length).map((a) => k.widgets.slider_anchor.y + k.widgets.slider_gap * a)), r = n.position(k.widgets.toggle_anchor.x, ci(ge.length).map((a) => k.widgets.toggle_anchor.y + k.widgets.toggle_gap * a)), i = n.position(k.widgets.radio_anchor.x, k.widgets.radio_anchor.y);
  pe.forEach((a, o) => a.position(e[o])), ge.forEach((a, o) => a.position(r[o])), fi[0].position(i).size(k.widgets.radio_size).shape(k.widgets.radio_shape), At.position(n.position(k.widgets.playbutton_anchor.x, k.widgets.playbutton_anchor.y)).size(k.widgets.playbutton_size), hr.position(n.position(k.widgets.backbutton_anchor.x, k.widgets.backbutton_anchor.y)), fr.position(n.position(k.widgets.resetbutton_anchor.x, k.widgets.resetbutton_anchor.y)), t.selectAll(null).data(pe).enter().append(ie), t.selectAll(null).data(ge).enter().append(ie), t.selectAll(null).data(HM).enter().append(ie), t.selectAll(null).data(fi).enter().append(ie);
}, BM = (t) => {
  Tt(Wi, (n) => n.widget.reset(t, n.default)), Tt(Ji, (n) => n.widget.reset(t, n.default)), Tt(Qi, (n) => n.widget.reset(t, n.default));
}, UM = b.dt, YM = b.L, Ho = b.r_var;
var D = [], $t = [], Jt, F;
const GM = dd(0, b.omega_var), VM = 2 * b.number_of_oscillators.range[1];
function el(t) {
  return {
    x: fn(t, "x"),
    y: fn(t, "y")
...
const KM = () => {
  ...
  for (let t = 0; t < D.length / 2; t++)
    D[t].domega = -D[D.length - t - 1].domega, D[D.length - t - 1].id = D[t].id;
  Tt(D, (t) => {
    t.active = t.id < b.number_of_oscillators.widget.value() ? 1 : 0;
  }), $t = Wu(D, (t) => t.active == 1), F = el($t), Jt = [{ x: b.tick, y: Math.sqrt(F.x * F.x + F.y * F.y) }];
}, ZM = () => {
  b.tick++, $t = Wu(D, (n) => n.active == 1);
  ...
  }), F = el($t), Jt.push({ x: b.tick, y: Math.sqrt(F.x * F.x + F.y * F.y) });
}, WM = () => {
  Tt(D, (t) => {
    t.active = t.id < b.number_of_oscillators.widget.value() ? 1 : 0;
  });
}, De = b.L, JM = 2 * b.number_of_oscillators.range[1], Qt = _t().domain([-De, De]), tn = _t().domain([-De, De]), ta = _t().domain([0, JM / 2]).range(b.agentsize), na = _t().range([0, 0.9]).domain([b.omega_0 - b.omega_var, b.omega_0 + b.omega_var]), ea = (t) => b.orlis_magic_switch.widget.value() ? Td(t) : Nd(t), _e = Ts().x(function(t) {
  return Qt(t.x);
}).y(function(t) {
  return tn(t.y);
});
...
const QM = (t, n) => {
  ...
  a.selectAll("." + O.agent).data(D).enter().append("circle").attr("class", O.agent).attr("r", function(s) {
    return ta(b.number_of_oscillators.widget.value());
  }).style("fill", function(s) {
    return ea(na(s.omega));
  }).attr("transform", function(s) {
    return "translate(" + Qt(s.r * Math.cos(s.theta)) + "," + tn(s.r * Math.sin(s.theta)) + ")";
  }).style("opacity", function(s) {
    return s.active ? 1 : 0;
  });
  const o = a.append("g").attr("class", O.inset).style("opacity", b.show_order_parameter.widget.value() ? 1 : 0);
  o.append("path").datum([{ x: -b.orderparameterlength, y: 0 }, { x: b.orderparameterlength, y: 0 }]).attr("d", _e).attr("class", O.caxis), o.append("path").datum([{ x: 0, y: -b.orderparameterlength }, { x: 0, y: b.orderparameterlength }]).attr("d", _e).attr("class", O.caxis), o.append("circle").attr("class", O.dot).attr("r", b.orderparametersize).attr("transform", "translate(" + Qt(b.orderparameterlength * F.x) + "," + tn(b.orderparameterlength * F.y) + ")"), o.append("path").datum(
    [
      { x: 0, y: 0 },
      { x: b.orderparameterlength * F.x, y: b.orderparameterlength * F.y }
    ]
  ).attr("class", O.op).attr("d", _e);
}, tA = (t, n) => {
  t.selectAll("." + O.agent).attr("r", function(e) {
    return ta(b.number_of_oscillators.widget.value());
    ...
    return ea(na(e.omega));
  }), fn($t, "omega"), b.comoving_reference_frame.widget.value() ? ye += b.dt * b.angular_speed.widget.value() * fn($t, "omega") / Math.PI * 180 : ye += 0, t.select("." + O.dot).attr("transform", "translate(" + Qt(b.orderparameterlength * F.x) + "," + tn(b.orderparameterlength * F.y) + ")"), t.select("." + O.op).datum(
    [
      { x: 0, y: 0 },
      { x: b.orderparameterlength * F.x, y: b.orderparameterlength * F.y }
    ]
  ).attr("class", O.op).attr("d", _e), t.selectAll("#origin").attr("transform", "rotate(" + ye + ")");
}, nA = (t, n) => {
  t.selectAll("." + O.agent).attr("r", function(e) {
    return ta(b.number_of_oscillators.widget.value());
  }).style("opacity", function(e) {
...
}, Dn = _t().domain(k.plot.domain).range([0, k.plot.width]), ra = _t().domain([0, 1]).range([0, -100]), rl = Ml(Dn).tickFormat(""), eA = Al(ra).tickFormat(""), il = Ts().x(function(t) {
  return Dn(t.x);
}).y(function(t) {
  return ra(t.y);
}), rA = (t, n) => {
  Dn.domain(k.plot.domain);
  const e = n.position(k.plot.anchor.x, k.plot.anchor.y);
  t.select("#plot").remove();
  const r = t.append("g").attr("class", O.plot).attr("transform", "translate(" + e.x + "," + e.y + ")").attr("id", "plot");
  r.append("text").text(k.plot.xlabel).attr("transform", "translate(" + Dn(k.plot.domain[1] / 2) + ",25)").attr("class", O.xlabel), r.append("text").text(k.plot.ylabel).attr("transform", "translate(-20," + ra(0.5) + ")rotate(-90)").attr("class", O.ylabel), r.append("g").call(rl).attr("class", O.xaxis), r.append("g").call(eA).attr("class", O.yaxis), r.append("path").datum(Jt).attr("d", il).attr("class", O.plotline);
}, al = (t) => {
  t.select("." + O.plotline).datum(Jt).attr("d", il), Jt.length > k.plot.domain[1] && (Dn.domain([b.tick - k.plot.domain[1], b.tick]), t.select("." + O.xaxis).call(rl), Jt.shift());
};
function iA(t, n, e) {
  ZM(), tA(t), al(n);
}
...
var Bo = {};
const aA = (t, n, e) => {
  At.value() == 1 ? Bo = Xf(() => iA(t, n), k.simulation.delay) : Bo.stop();
}, oA = (t, n, e, r) => {
  hr.update(() => BM(n)), At.update(() => aA(t, n)), fr.update(() => hi(t, n, e, r)), b.number_of_oscillators.widget.update(() => Xo(t, n)), b.orlis_magic_switch.widget.update(() => Xo(t, n)), b.initial_conditions.widget.update(() => hi(t, n, e, r)), b.show_order_parameter.widget.update(() => {
    t.selectAll("." + O.inset).transition().duration(1e3).style("opacity", b.show_order_parameter.widget.value() ? 1 : 0), n.selectAll("." + O.plot).transition().duration(1e3).style("opacity", b.show_order_parameter.widget.value() ? 1 : 0);
  });
}, sA = {
...
function uA(t, n = ol) {
  const e = pw(t, n), r = e.display, i = e.controls, a = e.grid;
  return XM(i, a), oA(r, i, a, n), hi(r, i, a, n), {
    halt() {
